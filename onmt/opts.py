...
def config_opts(parser):
    ...
    group.add('-src_lang', '--src_lang', required=False,
              help='source languge code')
    group.add('-tgt_lang', '--tgt_lang', required=False,
              help='target languge code')
...
def translate_opts(parser, dynamic=False):
    ...
    group.add('--model', '-model', dest='models', metavar='MODEL',
              nargs='+', type=str, default=[f'data/models/model.pt'], required=False,
    ...
    group.add('--input_type', '-input_type', default="tsv",
              help="File type of input source.")
