...
class Translation(object):
    ...
    __slots__ = ["src", "src_raw", "pred_sents", "attns", "pred_scores",
                 "gold_sent", "gold_score", "word_aligns", "best_pred_sent"]

    def __init__(self, src, src_raw, pred_sents,
                 attn, pred_scores, tgt_sent, gold_score, word_aligns, best_pred_sent=None):
        self.src = src
        ...
        self.best_pred_sent = best_pred_sent
    ...
    def log(self, sent_number):
        ...
        if self.best_pred_sent is None:
            best_pred = self.pred_sents[0]
            self.best_pred_sent = ' '.join(best_pred)
        best_score = self.pred_scores[0]
        msg.append('PRED {}: {}\n'.format(sent_number, self.best_pred_sent))
